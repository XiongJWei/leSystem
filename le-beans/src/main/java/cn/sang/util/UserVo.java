...
@ApiModel(value = "UserVo",description = "前台用户VO")
public class UserVo {
     ...
     * 状态(1:正常，0:禁用)
     */
    @ApiModelProperty("[非必填] 状态(1:正常，0:禁用)")
     ...
     * 手机号码
     */
    @ApiModelProperty("[非必填] 手机号码")
    private String mobile;
    /**
     * 密码盐
     */
    @ApiModelProperty("[非必填] 密码盐")
    private String mobileSalt;
    /**
     * 登录密码
     */
    @ApiModelProperty("[非必填] 登录密码")
