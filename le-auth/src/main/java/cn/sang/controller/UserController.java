...
import cn.sang.service.MailService;
import cn.sang.service.SmsService;
import cn.sang.util.Dto;
import cn.sang.util.DtoUtil;
import cn.sang.util.MD5;
    ...
    public Dto sendmail(String email, String password){
        ...
        try{
            ...
            if(user1!=null){
                ...
                mailService.sendHtmlMail("1807915746@qq.com", "1807915746@qq.com",
                        "领课教育激活", mail);
